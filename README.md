...
| mkdir gitTest|     |
| cd gitTest   |     |
| git init     | initialization of the hidden .git folder    |
| ls -a .git   |  list all files in a directory     |
| cat .git/HEAD| show the branch that GIT points to |
| cat .git/description      | repository description|
| cat .git/info/exclude      | general rules     |
| cat .git/config      | configuration settings     |
| ls -l .git/hooks      | list of hook scripts that can be run    |
| ls -l .git/refs/heads      | right bar list of local branches (for now - 0)    |
| ls -l .git/refs/tags      | list of tags     |
| ls -l .git/objects      |      |
| ls -l .git/objects/info      |      |
| ls -l .git/objects/pack      | shows if Git objects packed     |

<img src="https://github.com/user-attachments/assets/c30067bf-8583-4cd8-af8b-f5f12d8a26c0" style="height: 100;"/>
</div>
...
![image](https://github.com/user-attachments/assets/b50cd7ef-e52c-4349-8cd7-55ab1c460fc4)
...
![image](https://github.com/user-attachments/assets/2b30e4af-4834-42f3-8c04-d067370192a3)

**git log** - now starts with the latest commit 

**cat .git/refs/heads/main** - now points to the hash of the new commit

![image](https://github.com/user-attachments/assets/5a2dbe80-9d78-4d49-b7bf-7227ae504fb2)
...
![image](https://github.com/user-attachments/assets/d2b4a515-d62d-4539-ad1a-a9039b222db8)

turned everything back

![image](https://github.com/user-attachments/assets/db1455b1-829b-45e2-9cdf-d834588a4ab1)
...
.git/refs/heads/main
```
![image](https://github.com/user-attachments/assets/516397d5-56c5-4236-b292-523d2cfacb64)

![image](https://github.com/user-attachments/assets/beb66cec-800f-4daf-9dd1-c7f53601b30e)
...
![image](https://github.com/user-attachments/assets/a0b5089e-47ae-4c02-960b-43a026f60501)
...
![image](https://github.com/user-attachments/assets/7ed8866e-61bc-4a9f-925b-c12934f0ecb8)
...
![image](https://github.com/user-attachments/assets/1b3da4fc-070e-4508-9264-4929c4b48f9d)
...
![image](https://github.com/user-attachments/assets/4ca966cd-9a7c-4c53-be8f-4ce7ad2cb15b)
...
![image](https://github.com/user-attachments/assets/434d161d-1e17-4955-9a0c-55ccd0e97627)
...
![image](https://github.com/user-attachments/assets/ae4b5af4-aec6-44ee-ae6f-e424a7a3acc2)
...
![image](https://github.com/user-attachments/assets/5d2f9b50-22dd-4c3f-84f2-ca249e27e16e)
...
![image](https://github.com/user-attachments/assets/2ed27e4e-c0b9-44ff-b999-2bae426255cb)
...
![image](https://github.com/user-attachments/assets/2d7dce67-e72a-4730-b7f1-8b7960fa167c)
...
![image](https://github.com/user-attachments/assets/e8ba669b-0494-46cd-aab4-201100d7ca9f)

`git init -b main` - create a new repository in the current folder with the main branch

![image](https://github.com/user-attachments/assets/9fb60346-75d3-4a8b-bfb8-e2a8aab1c5da)
...
![image](https://github.com/user-attachments/assets/495fd78d-ca38-4fcb-a255-a6ac4649c41c)

refers to blob 89b24ecec50c07aef0d6640a2a9f6dc354a33125 which has content line1

![image](https://github.com/user-attachments/assets/43bfb90a-6e0a-4fba-a7dc-8d71b626b11a)
...
![image](https://github.com/user-attachments/assets/9a82d485-5bf7-4b7e-98ee-4ed04cd2e54b)

![image](https://github.com/user-attachments/assets/b6051bac-bf26-42dc-b2b9-8062a1dc3600)

![image](https://github.com/user-attachments/assets/aee2d60c-9bf6-4d17-8bc2-a55d714ef258)
...
```
![image](https://github.com/user-attachments/assets/5874a3f6-e3f6-4111-b9df-138a1cfc80e8)
...
![image](https://github.com/user-attachments/assets/5d0c69fa-f975-4ea4-b72c-f15bdfc60efa)

make a copy of repo1 in repo2 and output the history then compare it with the history in repo1

![image](https://github.com/user-attachments/assets/b70caf83-a599-4cf2-895b-6a5b1e4dfd23)

We can see that the history is the same

Check **.git/objects** in both folders

![image](https://github.com/user-attachments/assets/42136126-dc61-47b7-8872-c376696ee5a0)
...
![image](https://github.com/user-attachments/assets/d5367115-65d2-46fb-9d20-df7c741fce39)
...
![image](https://github.com/user-attachments/assets/a99d3350-26a1-4194-86bf-9dd22c7ba767)

the contents of the generated .patch files:

![image](https://github.com/user-attachments/assets/f6525316-eec4-4365-b574-8e67887ab264)
...
![image](https://github.com/user-attachments/assets/41c2cedb-f47e-4fc9-9aa5-be747f0a76e4)

![image](https://github.com/user-attachments/assets/62738e4d-14d0-4760-9654-7c33b80892fc)
...
![image](https://github.com/user-attachments/assets/f1cd9b92-ca6e-470e-b79c-d57506ba2a20)
...
![image](https://github.com/user-attachments/assets/924e3b4a-32d4-4953-8a64-7452d69ae077)

Copy the folder
cp -r test1 test2
Confirm that test2 has the same commit history as test1.

![image](https://github.com/user-attachments/assets/fc27f9cc-54d4-4ed0-b843-9b0b0b605928)
...
![image](https://github.com/user-attachments/assets/3d947e73-45db-4ad0-9307-123b45e18846)
...
![image](https://github.com/user-attachments/assets/4dbb2ecb-845e-4a63-b0be-c53b27a75056)

Push current hash as a new remote branch inside test2 folder aka myLocalRepo remote

![image](https://github.com/user-attachments/assets/0978fee9-d74a-485c-a57f-d9fd91e2a671)

Switch to test2 folder:

Confirm that the myNewBranchInTest2 branch now exists.

![image](https://github.com/user-attachments/assets/850738db-9f1d-406f-9251-d95ba194b665)


![image](https://github.com/user-attachments/assets/2ff6822e-dfe0-44d6-987b-2c3a325d1ca9)
